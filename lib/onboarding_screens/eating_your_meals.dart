...
class EatingYourMeals extends StatefulWidget {
  ...
  final String? initialEatingYourMeals;
  const EatingYourMeals(
      {super.key,
      this.selectedGender,
      this.selectedDate,
      this.selectedHeight,
  ...
  @override
  State<EatingYourMeals> createState() => _EatingYourMealsState();
}

class _EatingYourMealsState extends State<EatingYourMeals> {
  ...
  void initState() {
    ...
    if (widget.initialEatingYourMeals != null) {
      selectedActivity = widget.initialEatingYourMeals;
    }
  }
    ...
    return Scaffold(
                      ...
                      Navigator.push(context, MaterialPageRoute(
                        builder: (context) {
                          return PreparingYourMealsDaily(
                            ...
                            initialPreparingYourMealsDaily:
                                widget.timeSpendPreparingYourMealsDaily,
                          );
                        },
                      ));
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              "How much time do you usually spend eating your meals?",
                ...
                onPressed: () {
                  if (selectedActivity == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text(
                            "Please select how much time do you usually spend eating your meals."),
                      ),
                    );
                  } else {
                    print(
                        "Selected how much time do you usually spend eating your meals: $selectedActivity");
                    // Go to next screen
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return PreparingYourMealsDaily(
                          ...
                          selectedDietaryRestrictions:
                              widget.selectedDietaryRestrictions,
                          selectedEatingYourMeals: selectedActivity,
                          timeSpendPreparingYourMealsDaily:
                              widget.timeSpendPreparingYourMealsDaily,
                          selectedMeals: widget.selectedMeals,
                          selectedPrimaryGoal: widget.selectedPrimaryGoal,
