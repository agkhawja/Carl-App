...
class DietaryRestrictionsAllergies extends StatefulWidget {
  ...
  final List<String>? initialDietaryRestrictions; // Add this parameter

  const DietaryRestrictionsAllergies({
    super.key,
    this.selectedGender,
    this.selectedDate,
    this.selectedHeight,
  ...
  @override
  State<DietaryRestrictionsAllergies> createState() =>
      _DietaryRestrictionsAllergiesState();
}

class _DietaryRestrictionsAllergiesState
    extends State<DietaryRestrictionsAllergies> {
  ...
  void initState() {
    ...
    if (widget.initialDietaryRestrictions != null &&
        widget.initialDietaryRestrictions!.isNotEmpty) {
      // Convert API values to match our options (case-insensitive)
      for (var restriction in widget.initialDietaryRestrictions!) {
                      ...
                      Navigator.push(context, MaterialPageRoute(
                        builder: (context) {
                          return MealsConsumeDaily(
                            ...
                            initialMealsConsumeDaily: widget.selectedMeals,
                          );
                        },
                      ));
                    },
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Select one or more choices",
              ...
              child: ElevatedButton(
                onPressed: () {
                  if (selectedMeals.isEmpty) {
                    ...
                    print("Selected dietary restrictions: $selectedMeals");
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => MealsConsumeDaily(
                                selectedActivity: widget.selectedActivity,
                                selectedDailyStressLevel:
                                    widget.selectedDailyStressLevel,
                                selectedDate: widget.selectedDate,
                                ...
                                selectedBodyCompositionGoal:
                                    widget.selectedBodyCompositionGoal,
                                selectedDietaryRestrictions: selectedMeals,
                                selectedEatingYourMeals:
                                    widget.selectedEatingYourMeals,
                                timeSpendPreparingYourMealsDaily:
                                    widget.timeSpendPreparingYourMealsDaily,
